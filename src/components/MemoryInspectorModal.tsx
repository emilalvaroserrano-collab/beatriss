        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6 scrollbar-hide text-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2 text-zinc-200 focus:outline-none focus:border-[#00f2fe] font-medium"
                >
          ...
          {memoryState.compressedSummary && (
            <div className="p-4 rounded-2xl bg-purple-950/20 border border-purple-500/30 space-y-2">
              ...
              <p className="text-zinc-300 leading-relaxed bg-black/40 p-3 rounded-xl border border-purple-500/20 font-mono text-[11px]">
                {memoryState.compressedSummary}
              </p>
            </div>
          )}
                ...
                transcripts
                  ...
                  .map((turn) => {
                    ...
                    return (
                      <div
                        key={turn.id}
                        className="p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80 flex items-start justify-between gap-3"
                      >
                        ...
                        <span className="text-[10px] font-mono text-zinc-400 bg-zinc-800 px-2 py-1 rounded border border-zinc-700/60 shrink-0">
                          ~{estTokens} tokens
                        </span>
                      </div>
                    );
        ...
        <div className="px-6 py-4 bg-black/60 border-t border-white/10 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 font-semibold transition-all active:scale-95 cursor-pointer"
            >
              Done
            </button>
          </div>
