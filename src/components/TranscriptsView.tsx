    ...
    <div className="flex flex-col h-full bg-[#1c1c1e]/40 rounded-3xl border border-white/5 overflow-hidden backdrop-blur-2xl">
        ...
        <div className="px-4 py-2 bg-black/80 border-t border-white/10 flex items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2 overflow-hidden">
            {attachment.type === 'image' && attachment.dataUrl ? (
              ...
              <div className="p-2 rounded-lg bg-[#2c2c2e] text-[#00f2fe]">
      ...
      <form onSubmit={handleSubmit} className="p-3 bg-black/60 border-t border-white/5 flex items-center gap-2">
        ...
        <button
          ...
          disabled={!isConnected}
          className="p-2.5 rounded-full text-zinc-400 hover:text-cyan-400 hover:bg-cyan-500/10 disabled:opacity-40 transition-colors cursor-pointer shrink-0"
          title="Attach Image"
        >
        ...
        <button
          ...
          className="w-10 h-10 rounded-full flex items-center justify-center bg-[#007aff] text-white disabled:opacity-40 disabled:bg-[#3a3a3c] hover:bg-[#0056b3] transition-all shrink-0 cursor-pointer"
        >
