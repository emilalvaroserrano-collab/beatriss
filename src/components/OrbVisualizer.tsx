...
export const OrbVisualizer: React.FC<OrbVisualizerProps> = ({
  ...
  return (
    <div className="relative flex flex-col items-center justify-center p-6 bg-slate-900/60 rounded-2xl border border-slate-800 backdrop-blur-sm overflow-hidden group">
      {/* Background radial accent */}
      <div className="absolute inset-0 bg-gradient-to-b from-cyan-500/5 via-indigo-500/5 to-transparent pointer-events-none" />
      ...
      <div className="mt-2 text-center z-10">
        <div className="text-sm font-semibold text-slate-200 flex items-center justify-center gap-2">
          {status === 'speaking' ? (
            ...
            <span className="text-slate-400">Beatrice Active</span>
          )}
        </div>
