...
export const ContactsTool: React.FC<ContactsToolProps> = ({
  ...
  return (
    <div className="flex flex-col gap-3 text-xs text-zinc-100">
      {/* Banner / Auth Header */}
      <div className="flex items-center justify-between p-3 rounded-2xl bg-cyan-950/40 border border-cyan-500/20">
        <div className="flex items-center gap-2.5">
          <div className="p-2 rounded-xl bg-cyan-500/20 text-cyan-300">
            <Users className="w-4 h-4" />
          </div>
          <div>
            <div className="font-semibold text-cyan-200">Google People & Contacts API</div>
        ...
        <div className="flex items-center gap-2">
          {!accessToken && (
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white font-medium transition-all text-[11px]"
            >
              Authorize Contacts
            </button>
          )}
      ...
      {activeTab === 'directory' && (
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 bg-zinc-900/90 p-1.5 rounded-xl border border-white/10">
            ...
            <button
              onClick={() => handleFetchContacts(searchQuery)}
              className="px-2.5 py-1 bg-cyan-600 hover:bg-cyan-500 text-white rounded-lg text-[11px] font-medium"
            >
              Search
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                  ...
                  return (
                    ...
                    >
                      {c.avatarUrl ? (
                        ...
                        <div className="w-9 h-9 rounded-full bg-cyan-900/50 border border-cyan-500/30 flex items-center justify-center text-cyan-200 font-bold shrink-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {c.organization && (
                          <div className="text-[10px] text-cyan-400/80 truncate">{c.organization}</div>
                        )}
                      </div>
                    </div>
                  );
            ...
            <div className="md:col-span-3">
              {selectedContact ? (
                <div className="p-4 rounded-2xl bg-zinc-900/90 border border-white/10 space-y-4">
                  ...
                  <div className="flex items-start gap-3.5 border-b border-white/10 pb-3">
                    {selectedContact.avatarUrl ? (
                      ...
                      <div className="w-12 h-12 rounded-2xl bg-cyan-900/60 border-2 border-cyan-500/40 flex items-center justify-center text-cyan-200 text-base font-bold shadow-md">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {selectedContact.organization && (
                        <div className="text-cyan-400 text-[11px] flex items-center gap-1 mt-0.5">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        {onSendEmail && (
                          <button
                            ...
                            className="px-2 py-1 rounded-lg bg-cyan-600/30 hover:bg-cyan-600/50 text-cyan-300 font-medium text-[10px] transition-all flex items-center gap-1"
                          >
                ...
                <div className="text-center py-16 text-zinc-500 bg-zinc-900/40 rounded-2xl border border-white/5">
      ...
      {/* VIEW 2: ADD CONTACT */}
      {activeTab === 'add' && (
        <div className="p-4 rounded-2xl bg-zinc-900/90 border border-white/10 space-y-3 max-w-lg mx-auto">
          ...
          <div className="space-y-2.5">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 rounded-xl bg-black/50 border border-white/10 text-zinc-100 text-xs focus:outline-none focus:border-cyan-500"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 rounded-xl bg-black/50 border border-white/10 text-zinc-100 text-xs focus:outline-none focus:border-cyan-500 resize-none font-sans"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 text-white font-semibold transition-all flex items-center justify-center gap-2 text-xs mt-2"
            >
              {isCreating ? (
                <>
