    ...
    <div className="relative w-full h-full min-h-[460px] max-h-[640px] aspect-[9/16] mx-auto bg-black rounded-[32px] border border-white/10 overflow-hidden flex flex-col justify-between shadow-2xl">
      ...
      <div className="absolute inset-0 z-0 bg-slate-950 flex items-center justify-center overflow-hidden">
        ...
        {isScanning && streamType !== 'off' && (
          <div className="absolute inset-0 bg-cyan-500/20 border-4 border-cyan-400 rounded-3xl animate-pulse flex items-center justify-center z-20 backdrop-blur-xs">
            <div className="bg-black/80 px-4 py-2 rounded-2xl border border-cyan-400/50 flex items-center gap-2 text-cyan-300 font-mono text-xs shadow-lg">
          ...
          <div className="flex flex-col items-center justify-center text-center p-6 text-zinc-400 z-10 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="px-4 py-2.5 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold text-xs shadow-lg shadow-cyan-500/20 active:scale-95 transition-all flex items-center gap-2 cursor-pointer"
              >
